export function PageHeader({ title }: { title: string }) {
  return (
    <header>
      ...
      */}
      <h2 className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] font-display text-[55px] leading-[1.1] tracking-[-0.03em] font-extrabold text-ink md:text-display">
        {title}
      </h2>
    </header>
  );
