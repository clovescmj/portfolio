      ...
      subsections: [
                ...
                items: [
                  {
                    value: "9,877",
                    label: "Total claims",
                    caption: "Over a 12-month period."
                  },
                  {
                    value: "23%",
                    label: "Third-party claim",
                    caption: "2nd most common claim type."
                  }
                ]
              }
            }
        ...
        },
        {
          ...
          topics: [
            {
              body: [
                "To file a claim for third-party, our customers still needed to call our support team."
              ]
            },
            {
              body: [
          ...
          miniGrid: {
            rows: [
              [
                {
                  title: "Anguish",
                  body: "They don't know what the process is like."
                },
                {
                  title: "Frustration",
                  body: "File a claim without being guilty of the accident."
                }
              ],
              [
                {
                  title: "Anxiety",
                  body: "They don't know whether they will be paid or have their car repaired."
                },
                {
                  title: "Mistrust",
      ...
      groups: [
        {
          ...
          topics: [
            {
              title: "Within the first four weeks after launch, 40% of third-party claims were filed through the new digital self-service journey instead of by phone.",
              body: [
          ...
          stats: {
            items: [
              {
                value: "40%",
                label: "Third-party claims filed online"
              }
            ]
          }
        }
